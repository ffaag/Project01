...
<body>
	...
	<div id="header">
			...
			<div>
				<a href="http://localhost:8080/Book/pages/user/login.html">登录</a> |
				<a href="http://localhost:8080/Book/pages/user/regist.html">注册</a> &nbsp;&nbsp;
				<a href="http://localhost:8080/Book/pages/cart/cart.html">购物车</a>
				<a href="http://localhost:8080/Book/pages/manager/manager.html">后台管理</a>
			</div>
	</div>
	<div id="main">
		<div id="book">
